...
export default function NewsLetterHeader({ text }: { text: string }) {
	return (
		<div className="absolute z-40 w-full">
			<div className={`relative w-full md:w-[600px] lg:w-[800px] xl:w-[900px] h-[48px] xl:h-[60px] -ml-4 -skew-x-[20deg] overflow-hidden will-change-transform`}>
				{/* Fundo */}
			...
			<div className={`absolute top-0 w-full md:w-[520px] lg:w-[720px] xl:w-[820px] flex h-full items-center justify-end gap-x-4`}>
				<p className="hidden xl:block text-sm text-[#0D00FF] mt-2 font-bold mr-8">FIQUE POR DENTRO DAS ÚLTIMAS NOTÍCIAS DA EQUIPE</p>
